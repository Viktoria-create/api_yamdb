...
Sprint_10. Групповой проект YaMDb.
Цель работы - получить опыт командной работы.
...
git clone https://github..../.../api_yamdb
...
Кошельник Виктория - Тимлид, модели, view и эндпоинты.

Чупрунов Константин - Разработчик, вся часть управления пользователями.

Дмитриев Алексей - Разработчик, отзывы, комментарии, рейтинги произведений.
